...
//bool sudoku_dfs(vector<vector<char> >& board, vector)
///**
...
void printSudoku(const std::vector<vector<char> >& board) {
    for (int i = 0; i < 9; i++) {
        for (int j = 0; j < 9; j++) {
            cout << (board[i][j]) << " ";
        }
...
std::vector<vector<char>>& solveSudoku(
...
//    [".",".",".","4","1","9",".",".","5"],
//    [".",".",".",".","8",".",".","7","9"]];
// turn the above into a sudoku board
    ...
    // use SudokuSolver class to solve the sudoku board
    SudokuSolver s;
    s.solveSudoku(board);
...
//
//    int n = 9;
//    // build a 9 x 9 sudoku board of the above chars but as ints
//    int board1[9][9] = {
//            {5, 3, 0, 0, 7, 0, 0, 0, 0},
//            {6, 0, 0, 1, 9, 5, 0, 0, 0},
//            {0, 9, 8, 0, 0, 0, 0, 6, 0},
