...
#ifndef LEETCODE_PARKINGSYSTEM_H
#define LEETCODE_PARKINGSYSTEM_H
 ...
 *   parking lot. carType can be of three kinds: big, medium, or small, which
 *   are represented by 1, 2, and 3 respectively. A car can only park in a parking space of its carType. If there is no
...
#endif //LEETCODE_PARKINGSYSTEM_H
